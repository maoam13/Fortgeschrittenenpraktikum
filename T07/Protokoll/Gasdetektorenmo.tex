...
\hline 
$\tau [ms]$ & $1.882\pm 0.002 $ & $1.877\pm 0.004$ \\
\hline
\end{tabular}
...
\begin{figure}
\centering
\includegraphics[scale=0.5]{Bilder/GMlinear.PNG}
\includegraphics[scale=0.5]{Bilder/GMlog.PNG}
\caption{...}
\label{fig:GMCharakteristik}
\end{figure}
Die Ergebnisse der Charakteristikmessung sind in Abbildung \ref{fig:GMCharakteristik} dargestellt.\\
Mit zunehmender Spannung steigt die Messrate exponentiell, da immer mehr Ereignisse mit kleineren Energien registriert werden. Daher Müssen die Daten noch logarythmisiert werden, um das Plateau zu erkennen.\\
Nun wird an das Plateau ein Geradenfit angepasst und visuell abgeschätzt, wenn diese Gerade erreicht wird. Der so 
