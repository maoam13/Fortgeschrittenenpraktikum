...
Mit der Grenztemperatur kann nun anhand Abbildung \ref{fig:AnteilbestimmungProbe} die Zusammensetzung der Probe durch Ablesen bestimmt werden. Bei einer Grenztemperatur um \SI{160}{K} ergibt sich so ein Zn-Anteil von $x = 0.75 \pm 0.02$ mit Ablesefehler. Damit handelt es sich um eine GdAg$_{0.25}$Zn$_{0.75}$-Probe.
