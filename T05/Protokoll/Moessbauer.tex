...
\sigma _{ex} = \dfrac{- \ln(D_{ex})}{d \cdot n}
\end{equation*}
und der Fehler darauf zu:
\begin{equation*}
\sigma _{\sigma _{ex}} = \sqrt{\left( \dfrac{\sigma _{D_{ex}}}{D_{ex} \cdot d \cdot n} \right)^2 + \left( \dfrac{\sigma _n \cdot \ln(D_{ex})}{d \cdot n^2} \right)^2 + \left( \dfrac{\sigma _d \cdot \ln(D_{ex})}{d^2 \cdot n} \right)^2}
\end{equation*}
...
\begin{tabular}{|c|c|}
\hline 
Absorber & Atomdichte $\left[ \dfrac{10^{22}}{\SI{1}{cm^3}} \right]$ \\ 
\hline 
Stahl & 8,4 $\pm$ $\dfrac{0,1}{\sqrt{12}}$ \\
\hline 
Reines Eisen & 8,6 $\pm$ $\dfrac{0,1}{\sqrt{12}}$ \\
\hline
Eisensulfat & 0,6 $\pm$ $\dfrac{0,1}{\sqrt{12}}$ \\
\hline
\end{tabular} 
\caption{Atomdichten der Absorber. Der Fehler entstammt dem Digitalisierungfehler.}
...
\\
Die Durchlasswahrscheinlichkeiten von den 3 untersuchten Absorbern konnten zu $D_{Stahl} = 0,32408 \pm 0,00015$, $D_{Eisen} = 0,31549 \pm 0,00015$ und $D_{Eisensulfat} = 0,40552 \pm 0,00018$ bestimmt werden. Die dazugehörigen Extinktionsirkungsquerschnitte sind $\sigma_{Stahl} = \SI{536,5 \pm 6,5}{b}$, $\sigma_{Eisen} = \SI{536,5 \pm 6,5}{b}$ und $\sigma_{Eisensulfat} = \SI{6,02 \pm 0,30}{kb}$.\\
\\
